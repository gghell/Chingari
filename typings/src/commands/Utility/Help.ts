                    ...
                    embeds: [
                      this.client.utils
                        ...
                        .addFields([
                          ...
                          {
                            name: `Links`,
                            value: `**[Support Server](${this.client.config.server})** | **[Invite Me](https://discord.com/oauth2/authorize?client_id=1149253305873207340&permissions=8&scope=bot+applications.commands)** | **[Premium](${this.client.config.server})** | **[Vote](${this.client.config.voteUrl})**`,
                          },
                        ])
                        .setFooter({
                          text: `Made with 🔥 By RY4N Dev`,
                        ...
                        .setThumbnail(this.client.user.displayAvatarURL()).setImage(`https://cdn.discordapp.com/attachments/1123319552525221948/1254355853126144071/standard.gif?ex=667a82ec&is=6679316c&hm=c371e57d167bc99d530b87094e0af916131d0707e5fbc98d2dd1840b0dfe8160&`)
                    ],
                  })
                  .catch(() => {});
