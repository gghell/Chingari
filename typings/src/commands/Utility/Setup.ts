    ...
    this.exec = async (message: any, args: any, prefix: any) => {
      ...
      if (args[0].toLowerCase() === `player`) {
        ...
        const em = this.client.utils
          ...
          .setDescription(
            `**${this.client.user.username} Premium Supports Different Player Modes. You can choose any of the listed Below**\n\n${this.client.emoji.avonNew.emote} **Chingari Classic Style**\n${this.client.emoji.spotify.emote} **Chingari x Spotify Mode**\n${this.client.emoji.simple.emote} **Chingari Simple Mode**\n${this.client.emoji.special.emote} **Chingari Special Mode**\n${this.client.emoji.noButtons.emote} **Chingari No Button Mode**\n${this.client.emoji.oldStyle.emote} **Chingari Old School Style**`
          )
      ...
      if (
        ...
        if (args[1].toLowerCase() === `create`) {
          ...
          channel.send(
            `https://cdn.discordapp.com/attachments/1123319552525221948/1255638216065814720/standard_2.gif?ex=667ddbb7&is=667c8a37&hm=5a36ba239e0ba75ae501c24006b550a01411e7e6fd08ab89be291f5c73d1c6fd&`          );
